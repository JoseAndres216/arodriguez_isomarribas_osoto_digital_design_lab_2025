...
const int changeButton = 8;   ///< Pin connected to the change button
const int selectButton = 9;   ///< Pin connected to the select button

int lastChangeButtonState = LOW;  ///< Previous reading of the change button
int lastSelectButtonState = LOW;  ///< Previous reading of the select button

int changeButtonState = LOW;      ///< Current debounced state of the change button
int selectButtonState = LOW;      ///< Current debounced state of the select button

unsigned long lastChangeDebounceTime = 0;  ///< Timestamp for last change button state change
...
void loop() {
  if (handshakeDone) {
    handleButton(changeButton, changeButtonState, lastChangeButtonState, lastChangeDebounceTime, 'C', "changeButton Pressed");
