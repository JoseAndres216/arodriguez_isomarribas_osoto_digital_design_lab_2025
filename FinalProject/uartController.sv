 ...
 * @param button_A Indicates whether button A is pressed or activated.
 */
...
module uartController (
    ...
    output logic button_A            ///< Button A signal, high when activated (pressed)
);
    ...
    typedef enum logic [2:0] {
        ...
        PROCESS_COMMAND         ///< Handles incoming 'S' commands
    } state_t;
